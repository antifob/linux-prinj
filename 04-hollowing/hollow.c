...
int main(int argc, const char* const* argv)
{
	...
	if (3 != argc) {
		fprintf(stderr, "usage: ptrace <executable> <shellcode.file>\n");
		return 1;
	}

	if (0 != rdfile(argv[2], &buf, &len)) {
	...
	printf("Done! Run 'ps a' to identify the injected process.\n");
